...
def main():
    ...
    logging.info("Checking Craftbot FLOW IDEX...")

    plugin_profile_root_dir = os.path.join("resources", "craftbot_idex_profiles")
    plugin_profile_root_dir = os.path.abspath(plugin_profile_root_dir)
    plugin_quality_dir = os.path.join(plugin_profile_root_dir, "quality", "craftbot_idex")
