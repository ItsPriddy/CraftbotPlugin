...
class SnapmakerSettingsPlugin(Extension):
    """Plugin that install Craftbot profiles into Cura.
    ...
    def installResources(self) -> None:
        ...
        Logger.info("Installing settings for Craftbot printers...")

        self.__installMachineSettings("craftbot_idex_profiles")
